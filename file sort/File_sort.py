...
SOURCE_FOLDER = ""  # Change this for the folder to be sorted
DEST_FOLDER = ""    # Change destination folder (can be the same folder too)
...
CATEGORIES = {
    ...
    "Audio":[".mp3"],
    "Archives":[".zip",".7z"],
    "Reports & Forms":["report","Report","synopsis","Synopsis","Form","form"]
}
